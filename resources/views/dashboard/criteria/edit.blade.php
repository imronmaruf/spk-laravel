            ...
            <div class="col-md-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header bg-white py-4 d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Edit {{ $criteria->name }}</h4>
                    </div>

                    <!-- form  -->

                    <form class="col-lg-11 mx-auto mb-4 mt-4" method="POST" action="/dashboard/criterias/{{ $criteria->id }}">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('attribute') is-invalid @enderror" id="attribute"
                                ...
                                <option value="CORE FACTOR"
                                    {{ old('attribute', $criteria->attribute) === 'CORE FACTOR' ? 'selected' : '' }}>Core
                                    Factor</option>
                                <option value="SECONDARY FACTOR"
                                    {{ old('attribute', $criteria->attribute) === 'SECONDARY FACTOR' ? 'selected' : '' }}>
                                    Secondary Factor
                                </option>
                            </select>
